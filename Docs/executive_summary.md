# BÁO CÁO TÓM TẮT: SO SÁNH HIỆU QUẢ NOMA SECURITY
...
|-------------|------------------|------------------|-------------------|-----------|
| **Baseline** | 0.3516 | 0.0004 | 0.3520 | - |
| **AN** | 0.4308 | 0.0004 | 0.4313 | **+22.54%** |
| **DPA** | 0.8254 | 0.0004 | 0.8258 | **+134.64%** |
